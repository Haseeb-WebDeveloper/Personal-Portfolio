...
import { Star_2 } from "@/components/ui/star-2";
      ...
      <section id="mainContainer" className="h-full w-full ">
        ...
        <div id="work" className="section horizontal-wrapper w-full h-[100vh] overflow-hidden">
          <div className="horizontal-container flex flex-nowrap h-full gap-4">
            ...
            <div id="displaySection" className="panel w-full h-[100%]  flex-grow flex-shrink-0 basis-full  ">
                <div className="relative w-[100%] h-full flex flex-col md:flex-row items-center justify-around ">
                  <div className="flex flex-col  gap-4">
                    <h2 id="mainText" className="text-2xl md:text-5xl font-medium  leading-none">See What I've Built</h2>
                    <p className="text-md md:text-2xl font-normal max-w-2xl  text-foreground/70 leading-tight">Browse through the projects that demonstrate my skills, creativity, and commitment to quality. Here’s where my ideas come to life.</p>
                  </div>
