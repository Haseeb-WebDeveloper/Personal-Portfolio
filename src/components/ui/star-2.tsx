...
export const Star_2: React.FC<StarProps> = (props) => (
<svg className="coolshapes star-13 "  fill="none" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <g style={{"mixBlendMode":"overlay"}} mask="url(#cs_mask_1_star-13)">
      <path d="M200 0H0v200h200V0z" fill="gray" stroke="transparent" filter="url(#cs_noise_1_star-13)"/>
  </g>
  <defs>
  ...
  <defs>
      <filter height="100%" id="cs_noise_1_star-13" width="100%" x="0%" y="0%" filterUnits="objectBoundingBox">
